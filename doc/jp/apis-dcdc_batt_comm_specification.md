...
| **日付**  | **Rev.** | **担当** | **変更内容**                    |
|-----------|----------|----------|---------------------------------|
| 2020/9/14 | 0.5      | 岩瀬     | 初回リリース                    |
| 2020/9/18 | 0.55     | 岩瀬     | 2.概要と　6.OSSライセンスを追加 |
|           |          |          |                                 |
|           |          |          |                                 |
|           |          |          |                                 |
|           |          |          |                                 |
...
[**4.2.** **EController(ESSXTypeOES)** 6][]

[**5.** **詳細** 7][]

[**5.1.** **ESSXServer** 7][]

[**5.1.1.** **ESSXServerの起動方法** 7][]

[**5.1.2.** **ESSXServerの起動オプション等** 7][]

[**5.1.3.** **ESSXServerの設定ファイルについて** 8][]

[**5.1.4.** **ESSXServerのREST APIと仕様** 12][]

[**5.1.4.1.** **REST APIのリクエスト及びレスポンスの値についての捕捉** 12][]

[**5.2.** **コントローラー** 14][]

[**5.2.1** **ESSXtypeOES** 14][]

[**5.3.** **デバイス** 25][]

[**5.3.1** **EZA2500Device.py** 25][]

[**5.3.2** **BatteryEmulator** 26][]

[**5.4.** **低レベルデバイス** 27][]

[**5.4.1** **RS485(essx\_rs485.py)** 27][]

[**5.4.2** **ESSXModbusClient(essx\_modbus.py)** 27][]
