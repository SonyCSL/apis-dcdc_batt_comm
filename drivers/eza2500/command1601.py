...
class Command1601(eza2500_base.EZA2500CommandBase):
  """ EZA2500 16-1 """
  ...
  def __init__(self, device):
    super(Command1601, self).__init__(device)
    self.response = {}

  def pack_senddata(self, ad1, ad2, params = {}):
    req = pack("<BBBBB", 0x05 ,self.CMD_LEN ,ad1 ,ad2 ,31) + b"00"
  ...
  def unit_test(cls, dev = None, params = None):
    ...
    class Dummy:
      def __init__(self):
        ...
        _maj = 0
        _chksum = 0
        data = pack("<BBBBBBBH", 2, Command1601.ACK_LEN, 1, 2, 0x1f, _min ,_maj ,_chksum)
