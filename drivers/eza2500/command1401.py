...
class Command1401(eza2500_base.EZA2500CommandBase):
  """ EZA2500 14-1 """
  ...
  def __init__(self, device):
    super(Command1401, self).__init__(device)
    self.response = {}

  def pack_senddata(self, ad1, ad2, params = {}):
    req = pack("<BBBBB", 0x05 ,self.CMD_LEN ,ad1 ,ad2 ,17) + b"00"
  ...
  def recv(self):
    ...
    if _cmd == 0x11: #ACK
      (_vgn ,_vgnq ,_ign ,_ignq ,_vbn ,_vbnq ,_ibn ,_ibnq ,_wn ,_wnq ,_chksum) = unpack("<HHHHHHHHHHH", recv_data[5:])
      res["vgn"] = _vgn
      res["vgnq"] = _vgnq
      res["ign"] = _ign
      res["ignq"] = _ignq
  ...
  def unit_test(cls, dev = None, params = None):
    ...
    class Dummy:
      def __init__(self):
        ...
        _wnq = 0
        _chksum = 0
        data = pack("<BBBBBHHHHHHHHHHH", 2, Command1401.ACK_LEN, 1, 2, 0x11, _vgn ,_vgnq ,_ign ,_ignq ,_vbn ,_vbnq ,_ibn ,_ibnq ,_wn ,_wnq ,_chksum)
